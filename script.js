...
function generateItems(items) {
    ...
    items.forEach((item) => {
        ...
        doc.innerHTML = `  
                            ...
                            <div class="product-name text-gray-700 font-bold mt-2 text-sm justify-bottom">
                                ${item.name}
                            </div>
                            ...
                            <div class="product-price font-bold text-yellow-700 text-lg">
        ...
        "cursor-pointer", "product-add", "h-8", "w-28", "rounded", "bg-yellow-500", "text-white", "text-md",
